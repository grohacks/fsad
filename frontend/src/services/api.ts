...
export const paymentApi = {
  ...
  getMyPayments: () => api.get("/payments/history"),
  getAllPayments: () => api.get("/payments"),
  getPaymentByTransactionId: (transactionId: string) => api.get(`/payments/${transactionId}`),
  refundPayment: (appointmentId: number) => api.post(`/payments/${appointmentId}/refund`),
  getPaymentsByAppointment: (appointmentId: number) => api.get(`/payments/appointment/${appointmentId}`),
